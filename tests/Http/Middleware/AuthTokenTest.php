...
class AuthTokenTest extends TestCase
{
    ...
    {
        $invalidBody = Util::base64url_encode(json_encode([
        ...
        $hmac = Util::base64url_encode(hash_hmac('sha256', $invalidPayload, $secret, true));
    ...
    public function testDenysForExpiredToken(): void
    {
        ...
        $expiredBody = Util::base64url_encode(json_encode([
        ...
        $hmac = Util::base64url_encode(hash_hmac('sha256', $payload, $secret, true));
    ...
    public function testRuns(): void
    {
        ...
        $body = Util::base64url_encode(json_encode([
            'iss' => 'https://shop-name.myshopify.com/admin',
            'dest' => 'https://shop-name.myshopify.com',
            'aud' => env('SHOPIFY_API_KEY'),
            'sub' => '123',
