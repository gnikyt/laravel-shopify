...
class EnableJwtSupportCommand extends JobMakeCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'shopify-app:enable-jwt';
     ...
     * @var string
     */
    protected $description = 'Add support for Shopify JWT authentication';
    ...
    {
        return __DIR__.'/stubs/jwt.bootstrap.stub';
    }
