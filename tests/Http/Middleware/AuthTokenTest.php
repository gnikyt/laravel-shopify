...
class AuthTokenTest extends TestCase
{
    ...
    {
        $invalidBody = Helpers::base64url_encode(json_encode([
        ...
        $hmac = Helpers::base64url_encode(hash_hmac('sha256', $invalidPayload, $secret, true));
    ...
    public function testDenysForExpiredToken(): void
    {
        ...
        $expiredBody = Helpers::base64url_encode(json_encode([
        ...
        $hmac = Helpers::base64url_encode(hash_hmac('sha256', $payload, $secret, true));
    ...
    public function testRuns(): void
    {
        ...
        $body = Helpers::base64url_encode(json_encode([
            'iss' => 'https://shop-name.myshopify.com/admin',
            'dest' => 'https://shop-name.myshopify.com',
            'aud' => env('SHOPIFY_API_KEY'),
            'sub' => '123',
